...
const partners = [
  ...
  { src: "/images/Noor-Ride-Transparent-01-300x225.png", alt: "Noor Ride Logo - Setkorp Partner" },
  { src: "/images/WhatsApp_Image_2023-12-27_at_12.56.51_e9e64087-removebg-preview-300x78.png", alt: "Policy Bazaar UAE Logo" },
  { src: "/images/SAAL-Consulting-details.jpeg-150x150.jpg", alt: "SAAL Consulting Logo" },
  { src: "/images/juggernot-1-300x300.jpg", alt: "Juggernot AI Logo" },

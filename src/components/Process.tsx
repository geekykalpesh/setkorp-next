      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-80px" }}
            transition={{ type: "spring", ...springConfigs.smooth, delay: 0.3 }}
          >
            <CardSpotlight
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-80px" }}
            transition={{ type: "spring", ...springConfigs.smooth, delay: 0.4 }}
          >
            <CardSpotlight
        ...
        <motion.div 
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ type: "spring", ...springConfigs.smooth, delay: 0.5 }}
        >
          <div 
